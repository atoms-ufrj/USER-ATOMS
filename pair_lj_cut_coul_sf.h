...
PairStyle(lj/cut/coul/sf,PairLJCutCoulSF)

#else

#ifndef LMP_PAIR_LJ_CUT_COUL_SF_H
#define LMP_PAIR_LJ_CUT_COUL_SF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutCoulSF : public Pair {
 public:
  PairLJCutCoulSF(class LAMMPS *);
  ~PairLJCutCoulSF();
